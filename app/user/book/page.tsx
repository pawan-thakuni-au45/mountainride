            ...
            <div className='max-w-7xl mx-auto space-y-16 shadow-2xl'>
                ...
                <div className='grid grid-cols-2 gap-3 '>
                    {VEHICLE.map((v, i) => {
                        ...
                        return <div onClick={() => setVehicle(v.id )} key={v.id} className={`relative flex items-center transition-all duration-200 p-3 border ${active ? "bg-zinc-900 shadow-lg" : "bg-zinc-50"} `}>
